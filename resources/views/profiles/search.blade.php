            ...
            <div class="px-3 border bg-light">
                @foreach($details as $user)
                    ...
                    <div class="d-flex align-items-center my-3 ">
                        <a href="{{route('profile.index',$user->username) }}" style="width: 56px; height: 56px;">
                            <img src="{{ asset($user->profile->getProfileImage()) }}" class="rounded-circle w-100">
                        </a>
                        <div class='d-flex flex-column pl-3'>
                            <a href="{{route('profile.index', $user->username)}}" class='h5 m-0 text-dark text-decoration-none' >
